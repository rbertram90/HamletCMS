                        ...
                        <div class="column">
                            ...
                            <div class="field">
                                <div class="ui message">
                                    <p>This template uses the Smarty templating engine, for more information see: <a href="https://www.smarty.net/docs/en/smarty.for.designers.tpl" target="_blank">Smarty for template designers</a>.</p>
