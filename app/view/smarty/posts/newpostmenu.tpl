...
<div class="ui grid">
    <div class="one column row">
        <div class="column">
            {viewCrumbtrail(array("/blog/overview/{$blog['id']}", "{$blog['name']}"), 'Create New Post')}
        </div>
    </div>
    ...
    <div class="two columns row">
        ...
        <div class="column">
            <div class="ui segment clearing">
                ...
                <p><a href="/posts/create/{$blog.id}/video">Video Post</a></p>
